...
@section('title', 'Tax Services - Adamcresco')

@section('content')
<!-- Page Header Start -->
<div class="container-fluid bg-breadcrumb">
    <div class="container text-center py-5" style="max-width: 900px;">
        <h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">Tax Services</h4>
        <ol class="breadcrumb d-flex justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
            <li class="breadcrumb-item"><a href="/">Home</a></li>
            <li class="breadcrumb-item"><a href="#">Services</a></li>
            <li class="breadcrumb-item active text-primary">Tax</li>
        </ol>    
    </div>
</div>
<!-- Page Header End -->
    ...
    <div class="container py-5">
        <div class="row g-5 align-items-center">
            <div class="col-lg-6 wow fadeInLeft" data-wow-delay="0.2s">
                <div>
                    <h4 class="text-primary">Tax Services</h4>
                    ...
                    <div class="row g-4 mt-4">
                        <div class="col-sm-6">
                            <a href="/services/us-taxation" class="btn btn-primary rounded-pill py-3 px-5 flex-shrink-0">Learn More</a>
                        </div>
            ...
            <div class="col-lg-6 wow fadeInRight" data-wow-delay="0.2s">
                <div class="bg-primary rounded position-relative overflow-hidden">
                    <img src="{{ asset('img/service-tax-1.svg') }}" class="img-fluid rounded w-100" alt="Tax Services">
                    <div class="" style="position: absolute; top: -15px; right: -15px;">
                        <img src="{{ asset('img/service-tax-2.svg') }}" class="img-fluid" style="width: 150px; height: 150px; opacity: 0.7;" alt="Tax Planning">
                    </div>
                    <div class="" style="position: absolute; top: -20px; left: 10px; transform: rotate(90deg);">
                        <img src="{{ asset('img/service-tax-3.svg') }}?v={{ time() }}" class="img-fluid" style="width: 100px; height: 150px; opacity: 0.9;" alt="Tax Calculator">
                    </div>
                    <div class="rounded-bottom">
                        <img src="{{ asset('img/service-tax-4.svg') }}?v={{ time() }}" class="img-fluid rounded-bottom w-100" alt="Tax Planning Timeline">
                    </div>
                </div>
            </div>
        </div>
