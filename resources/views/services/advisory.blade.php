...
@section('title', 'Advisory Services - Adamcresco')

@section('content')
<!-- Page Header Start -->
<div class="container-fluid bg-breadcrumb">
    <div class="container text-center py-5" style="max-width: 900px;">
        <h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">Advisory Services</h4>
        <ol class="breadcrumb d-flex justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
            <li class="breadcrumb-item"><a href="/">Home</a></li>
            <li class="breadcrumb-item"><a href="#">Services</a></li>
            <li class="breadcrumb-item active text-primary">Advisory</li>
        </ol>    
    </div>
</div>
<!-- Page Header End -->
    ...
    <div class="container py-5">
        <div class="row g-5 align-items-center">
            <div class="col-lg-6 wow fadeInLeft" data-wow-delay="0.2s">
                <div>
                    <h4 class="text-primary">Advisory Services</h4>
                    <h1 class="display-5 mb-4">Strategic Guidance for Business Transformation</h1>
                        ...
                        <div class="col-md-6">
                            <div class="d-flex">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0">Strategic guidance for business optimization</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="d-flex">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0">Expert support for business transactions</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="d-flex">
                                ...
                                <div>
                                    <h4>Restructuring</h4>
                                    <p class="mb-0">Comprehensive turnaround management</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="d-flex">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0">Internal audit and governance support</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-4 mt-4">
                        <div class="col-sm-6">
                            <a href="/services/business-restructuring" class="btn btn-primary rounded-pill py-3 px-5 flex-shrink-0">Learn More</a>
                        </div>
            ...
            <div class="col-lg-6 wow fadeInRight" data-wow-delay="0.2s">
                <div class="bg-primary rounded position-relative overflow-hidden">
                    <img src="{{ asset('img/service-advisory-1.svg') }}" class="img-fluid rounded w-100" alt="Advisory Services">
                    <div class="" style="position: absolute; top: -15px; right: -15px;">
                        <img src="{{ asset('img/service-advisory-2.svg') }}" class="img-fluid" style="width: 150px; height: 150px; opacity: 0.7;" alt="Strategic Collaboration">
                    </div>
