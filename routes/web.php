...
Route::view('/who-we-are', 'who-we-are');
Route::view('/what-we-do', 'what-we-do');
Route::view('/our-purpose', 'our-purpose');
Route::view('/governance', 'governance');

// Service Routes
Route::view('/services/assurance', 'services.assurance');
Route::view('/services/audit', 'services.audit');
Route::view('/services/tax', 'services.tax');
Route::view('/services/advisory', 'services.advisory');
Route::view('/services/business-services-outsourcing', 'services.business-services-outsourcing');
Route::view('/services/business-process', 'services.business-process');
Route::view('/services/internal-audit', 'services.internal-audit');
Route::view('/services/bookkeeping', 'services.bookkeeping');
Route::view('/services/business-restructuring', 'services.business-restructuring');
Route::view('/services/us-taxation', 'services.us-taxation');
Route::view('/services/financial-advising', 'services.financial-advising');

// Nested Service Routes - Using existing view files
Route::view('/services/assurance/ifrs-corporate-reporting', 'services.audit'); // Using existing audit view
Route::view('/services/assurance/proposed-standards', 'services.assurance'); // Using existing assurance view

// Nested Service Routes - Tax (using existing views)
Route::view('/services/tax/us-taxation', 'services.us-taxation'); // Using existing US taxation view
Route::view('/services/tax/canadian-tax-services', 'services.tax'); // Using existing tax view

// Nested Service Routes - Advisory (using existing views)
Route::view('/services/advisory/deal-advisory', 'services.advisory'); // Using existing advisory view
Route::view('/services/advisory/forensics', 'services.advisory'); // Using existing advisory view
Route::view('/services/advisory/management-consulting', 'services.advisory'); // Using existing advisory view
Route::view('/services/advisory/risk-advisory-services', 'services.advisory'); // Using existing advisory view

// Nested Service Routes - Business Services (using existing views)
Route::view('/services/business-services/outsourced-accounting-bookkeeping', 'services.business-services-outsourcing'); // Using existing view
Route::view('/services/business-services/legal-company-secretarial', 'services.business-services-outsourcing'); // Using existing view
Route::view('/services/business-services/compliance-reporting', 'services.business-services-outsourcing'); // Using existing view
Route::view('/services/business-services/payroll-hr-global-mobility', 'services.business-services-outsourcing'); // Using existing view
Route::view('/services/business-services/financial-reporting', 'services.financial-advising'); // Using existing view
Route::view('/services/business-services/finance-function-future', 'services.financial-advising'); // Using existing view

// Nested Industry Routes - Using placeholder views for now
Route::view('/Industries/financial-services/asset-management', 'services.financial-advising'); // Placeholder
Route::view('/Industries/financial-services/financial-services-advisory', 'services.advisory'); // Placeholder
Route::view('/Industries/financial-services/financial-services-tax', 'services.tax'); // Placeholder
Route::view('/Industries/financial-services/insurance', 'services.assurance'); // Placeholder
Route::view('/Industries/financial-services/banking', 'services.financial-advising'); // Placeholder

// Sustainability Routes
Route::view('/sustainability/climate-change-risk', 'sustainability.climate-change-risk');
Route::view('/sustainability/ghg-accounting', 'sustainability.ghg-accounting');
Route::view('/sustainability/sustainability-reporting', 'sustainability.sustainability-reporting');
Route::view('/sustainability/climate-finance-advisory', 'sustainability.climate-finance-advisory');
Route::view('/sustainability/carbon-emission', 'sustainability.carbon-emission');
